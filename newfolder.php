    ...
    <form class="" action="" target="_parent" method="post" >
      <div class="form-group well ">
        <div class="input-group">
          ...
          <input class="form-control" name="newfolder" type="text" placeholder="Folder Name" required>
        </div><br>
      <button class="btn btn-primary" name="submit2" type="submit" id="submit2" value="folder"><i class="glyphicon glyphicon-floppy-disk"></i> Save</button>
    </div>
    </form>
    </div>';}
  if(empty($_SESSION['login_user'])){
