...
include("./page.php");
  ...
  echo "<p><a href='newfolder.php".$row['id']."'><i class='text-primary glyphicon glyphicon-plus'></i></a><span class='text-primary'> New Folder</span></p>";
  ...
  if (!$result) {
    ...
    $folder = $row['id'];
      ...
      if($pos='admin'){
        echo "<li><a href='newtable.php".$row['id']."'><i class='text-primary glyphicon glyphicon-plus'></i></a><span class='text-primary'> New Folder</span></li>";
        echo "<li><a href='newtable.php?newtableid=".$row['id']."'><i class='text-success glyphicon glyphicon-plus'></i></a><span class='text-success'> New Table</span></li>";
      }
